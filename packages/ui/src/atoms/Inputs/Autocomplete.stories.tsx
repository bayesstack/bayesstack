              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    ...
                    <span style={{ fontSize: 11, color: "#68807D" }}>{item.email}</span>
                  </div>
                </div>
        ...
        {selectedUser && (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 12, color: "#68807D" }}>{selectedUser.email}</div>
            </div>
...
export const SizesAndStates: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 380 }}>
      <div>
        <h5 style={{ margin: "0 0 6px 0", fontSize: 12, color: "#68807D" }}>Small (32px)</h5>
        <Autocomplete
          size="sm"
      ...
      <div>
        <h5 style={{ margin: "0 0 6px 0", fontSize: 12, color: "#68807D" }}>Medium Default (38px)</h5>
        <Autocomplete
          size="md"
      ...
      <div>
        <h5 style={{ margin: "0 0 6px 0", fontSize: 12, color: "#68807D" }}>Large (44px)</h5>
        <Autocomplete
          size="lg"
      ...
      <div>
        <h5 style={{ margin: "0 0 6px 0", fontSize: 12, color: "#68807D" }}>Error State</h5>
        <Autocomplete
          size="md"
          error
      ...
      <div>
        <h5 style={{ margin: "0 0 6px 0", fontSize: 12, color: "#68807D" }}>Disabled State</h5>
        <Autocomplete
          size="md"
          disabled
