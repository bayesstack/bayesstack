      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 40, maxWidth: 600, padding: 10 }}>
        ...
        <div style={{ background: "#FFFFFF", border: "1px solid #E2ECEB", borderRadius: 14, padding: 24 }}>
          ...
          <Slider
            ...
            tooltipFormatter={(v) => `$${v}`}
          />
          <div style={{ marginTop: 20, fontSize: 13, color: "#4A6360" }}>
        ...
        >
          ...
          <Slider
            ...
            marks={{
              ...
              50: (
                <div style={{ textAlign: "center" }}>
                  <div style={{ fontWeight: 700, fontSize: 12, color: "#AD4E00" }}>50°C</div>
                  <span style={{ fontSize: 10, padding: "2px 6px", background: "#FFF7E6", color: "#AD4E00", borderRadius: 4, fontWeight: 600, display: "inline-block", marginTop: 3 }}>
                    Warm
                  </span>
                </div>
              ),
        ...
        <div style={{ background: "#FFFFFF", border: "1px solid #E2ECEB", borderRadius: 14, padding: 24 }}>
          ...
          <div style={{ display: "flex", gap: 60, alignItems: "center", justifyContent: "center", height: 260 }}>
            <div style={{ textAlign: "center" }}>
              ...
              />
              <div style={{ marginTop: 12, fontSize: 12, color: "#4A6360", fontWeight: 600 }}>Treble</div>
            </div>
            ...
            <div style={{ textAlign: "center" }}>
              <Slider
                ...
                tooltipFormatter={(v) => `${v}dB`}
              />
              <div style={{ marginTop: 12, fontSize: 12, color: "#4A6360", fontWeight: 600 }}>Bass</div>
            </div>
            ...
            <div style={{ textAlign: "center" }}>
              <Slider
                ...
                tooltipFormatter={(v) => `${v}%`}
              />
              <div style={{ marginTop: 12, fontSize: 12, color: "#4A6360", fontWeight: 600 }}>Band Pass</div>
            </div>
          </div>
        </div>
      </div>
