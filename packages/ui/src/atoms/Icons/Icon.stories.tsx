      ...
      <div style={{ fontFamily: "Outfit, Inter, sans-serif", padding: "12px 16px", maxWidth: 1150, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16, marginBottom: 20 }}>
          ...
          <div style={{ position: "relative", width: "100%" }}>
            ...
            />
            <div style={{ position: "absolute", left: 14, top: 13, color: "#68807D" }}>
        ...
        <div style={{ fontSize: 13, color: "#68807D", marginBottom: 16, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        {filteredIcons.length === 0 && (
          <div style={{ textAlign: "center", padding: "48px 0", color: "#68807D" }}>
