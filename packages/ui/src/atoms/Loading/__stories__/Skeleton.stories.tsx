      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 680 }}>
        ...
        <div style={{ background: "#FFFFFF", padding: "16px 24px", borderRadius: 12, border: "1px solid #D7E8E4", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            ...
            <div style={{ fontSize: 12, color: "#4A6360" }}>Toggle state to see seamless transitions between Skeleton placeholders and real rendered components.</div>
          </div>
          <Switch
            checked={loading}
        ...
        <div style={{ background: "#FFFFFF", padding: 24, borderRadius: 12, border: "1px solid #D7E8E4" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            {/* Avatars & Buttons */}
            <div>
              <div style={{ fontSize: 12, color: "#4A6360", fontWeight: 600, marginBottom: 8 }}>Avatars & Buttons</div>
            ...
            <div>
              <div style={{ fontSize: 12, color: "#4A6360", fontWeight: 600, marginBottom: 8 }}>Image Media & Form Inputs</div>
            ...
            <div>
              <div style={{ fontSize: 12, color: "#4A6360", fontWeight: 600, marginBottom: 8 }}>Title & Paragraph Lines</div>
              {loading ? (
                <>
