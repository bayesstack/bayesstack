...
export function UserCards({
  ...
  return (
    ...
    >
      {users.map((user) => (
        <div key={user.id} className="bs-user-card">
          <div className="bs-user-card-header">
            ...
            <div className="bs-user-card-info">
              <h4 className="bs-user-card-name">{user.name}</h4>
              <span className="bs-user-card-role">{user.role}</span>
              {user.email && (
                <span className="bs-user-card-email">{user.email}</span>
              )}
            </div>
          </div>
          ...
          {user.tags && user.tags.length > 0 && (
            <div className="bs-user-card-tags">
              {user.tags.map((tag) => (
          ...
          {/* User Stats Row */}
          {user.stats && (
            <div className="bs-user-card-stats">
          ...
          {/* Actions Footer */}
          <div className="bs-user-card-actions">
            <Button
              size="xs"
              variant="secondary"
              style={{ flex: 1 }}
